            ...
            <div className="title-bar--main mb-20">
              <div className="l-product-wrapper flex space-between flex-middle">
                ...
                <div className="title-bar--main-right flex">
                  <button
                    type="button"
                    className="ant-btn ant-btn-primary btn_Save ant-btn ml-20"
                  >
                    <div className="flex flex-middle flex-center">+ Thêm</div>
                  </button>
                </div>
              </div>
            </div>
